...
namespace layui.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var sql = "select to_char(logdate,'hh24:MI') as logtime,operator as userid,scrap_slot_id as slot,heatid,amount from CSCRAP_OUTPUT_LOG where logdate >sysdate-1 and materialid ='Scrap' order by logdate desc  ";     
